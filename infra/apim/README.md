...
2. Resource group exists (e.g., `pf-dev-rg`)
3. Backend API deployed (`pf-dev-api.azurewebsites.net`)
...
APIM_PRINCIPAL_ID=$(az apim show -n pf-dev-apim2 -g rg-pf-dev --query identity.principalId -o tsv)
...
- `https://pf-dev-apim2.azure-api.net/api/devices/{deviceId}/effective-policy`

Instead of:
- `https://pf-dev-api.azurewebsites.net/api/devices/{deviceId}/effective-policy`
